...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen bg-marble ancient-texture flex items-center justify-center p-4 sm:p-6">
      {/* Background Pattern */}
      ...
      <div className="w-full max-w-sm sm:max-w-md relative z-10">
        ...
        <div className="mb-4 sm:mb-6">
          <Link href="/">
            <Button
              variant="ghost"
              className="text-roman-red hover:bg-roman-gold/10 hover:text-roman-gold font-classical text-sm sm:text-base touch-manipulation active:scale-95"
            >
        ...
        <Card className="glass-effect shadow-roman border-roman-gold/20">
          <CardHeader className="text-center space-y-1 pb-4 sm:pb-6 px-4 sm:px-6">
            <div className="flex justify-center mb-3 sm:mb-4">
              <div className="p-2 sm:p-3 bg-roman-gradient rounded-lg shadow-roman">
                <LogIn className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
              </div>
            </div>
            <CardTitle className="text-xl sm:text-2xl font-classical font-bold text-roman-red">
              Welcome Back
            </CardTitle>
          ...
          <CardContent className="space-y-3 sm:space-y-4 px-4 sm:px-6 pb-4 sm:pb-6">
            ...
            <Button
              ...
              disabled={isLoading}
              className="w-full bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 touch-manipulation active:scale-95"
              size="lg"
            >
